...
#
# Script generated by Vivado on Wed Apr 22 12:44:21 +0530 2026
...
export RDI_DATADIR="N:/Xilinx/2025.1/Vivado/data"

# set xvlog options
xvlog_opts="--incr --relax "

# script info
echo -e "vram.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot vram xil_defaultlib.vram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim vram -key {Behavioral:sim_1:Functional:vram} -tclbatch cmd.tcl -protoinst "protoinst_files/vram.protoinst" -protoinst "protoinst_files/clk_gen.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="N:/Xilinx/2025.1/Vivado/data/xsim"
  fi
